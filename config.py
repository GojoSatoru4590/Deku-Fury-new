...
#Database --⚠️ REQUIRED--
DB_URL = os.environ.get("DB_URL", "mongodb+srv://sn117020:g3tULq1KLqxgzfgd@cluster0.ju3tzdx.mongodb.net/?retryWrites=true&w=majority&appName=DekuFuryBot")
...
DBV_NAME = os.environ.get("VERIFY_DBNAME", "Deku_FuryBot")


TOKEN_PIC = os.environ.get("TOKEN_PIC", "https://graph.org/file/96f42ea1ef1da9b0aa8dc-d4c5a7493a8f465db5.jpg")
...
START_PIC = os.environ.get("START_PIC", "https://graph.org/file/f47115fca468d2729ec46-82018df15c60913e58.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://graph.org/file/5af4fa39d2d3d6c98666a-1598c902617abd16ea.jpg")

                        
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://graph.org/file/248175684faf82eff03c6-2300075c6cd4b1d5bf.jpg")).split() #Required
